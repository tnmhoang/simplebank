...
import (
	...
	mockdb "github.com/tnmhoang/simplebank/db/mock"
	db "github.com/tnmhoang/simplebank/db/sqlc"
	"github.com/tnmhoang/simplebank/token"
	"github.com/tnmhoang/simplebank/util"
)

func TestTransferAPI(t *testing.T) {
	// Test cases for Transfer API would go here
	amount := int64(10)
	...
	for i := range testCases {
		...
		t.Run(tc.name, func(t *testing.T) {
			...
			// Marshal body data to JSON format
